...
export async function storeCharacter(character, user) {
    
    let characterName = character.name;
    let userName = user.profile["cognito:username"];
    
    console.log("storing character to s3", character, "for user", userName, user);

    //2025-01-25: copied from https://docs.aws.amazon.com/sdk-for-javascript/v2/developer-guide/s3-example-photo-album.html
    let characterKey = encodeURIComponent(userName) + "/" + characterName + ".json";
